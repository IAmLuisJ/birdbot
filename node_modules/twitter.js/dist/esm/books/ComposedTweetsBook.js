...
var _ComposedTweetsBook_instances, _ComposedTweetsBook_nextToken, _ComposedTweetsBook_previousToken, _ComposedTweetsBook_hasMadeInitialRequest, _ComposedTweetsBook_fetchPages;
...
export class ComposedTweetsBook extends BaseBook {
    ...
    constructor(client, options) {
         ...
         */
        _ComposedTweetsBook_nextToken.set(this, void 0);
        /**
         * The token for fetching previous page
         */
        _ComposedTweetsBook_previousToken.set(this, void 0);
        /**
         ...
         */
        _ComposedTweetsBook_hasMadeInitialRequest.set(this, void 0);
        this.hasMore = true;
     ...
     */
    async fetchNextPage() {
        if (!__classPrivateFieldGet(this, _ComposedTweetsBook_hasMadeInitialRequest, "f")) {
            __classPrivateFieldSet(this, _ComposedTweetsBook_hasMadeInitialRequest, true, "f");
            return __classPrivateFieldGet(this, _ComposedTweetsBook_instances, "m", _ComposedTweetsBook_fetchPages).call(this);
        }
        if (!__classPrivateFieldGet(this, _ComposedTweetsBook_nextToken, "f"))
            throw new CustomError('PAGINATED_RESPONSE_TAIL_REACHED');
        return __classPrivateFieldGet(this, _ComposedTweetsBook_instances, "m", _ComposedTweetsBook_fetchPages).call(this, __classPrivateFieldGet(this, _ComposedTweetsBook_nextToken, "f"));
    }
    /**
    ...
    async fetchPreviousPage() {
        if (!__classPrivateFieldGet(this, _ComposedTweetsBook_previousToken, "f"))
            throw new CustomError('PAGINATED_RESPONSE_HEAD_REACHED');
        return __classPrivateFieldGet(this, _ComposedTweetsBook_instances, "m", _ComposedTweetsBook_fetchPages).call(this, __classPrivateFieldGet(this, _ComposedTweetsBook_previousToken, "f"));
    }
}
_ComposedTweetsBook_nextToken = new WeakMap(), _ComposedTweetsBook_previousToken = new WeakMap(), _ComposedTweetsBook_hasMadeInitialRequest = new WeakMap(), _ComposedTweetsBook_instances = new WeakSet(), _ComposedTweetsBook_fetchPages = 
// #### 🚧 PRIVATE METHODS 🚧 ####
async function _ComposedTweetsBook_fetchPages(token) {
    ...
    __classPrivateFieldSet(this, _ComposedTweetsBook_nextToken, data.meta.next_token, "f");
    __classPrivateFieldSet(this, _ComposedTweetsBook_previousToken, data.meta.previous_token, "f");
