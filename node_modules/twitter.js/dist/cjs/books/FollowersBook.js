 ...
 */
class FollowersBook extends BaseBook_1.BaseBook {
    /**
...
exports.FollowersBook = FollowersBook;
...
async function _FollowersBook_fetchPages(token) {
    const followersCollection = new util_1.Collection();
