...
import type { APITweetReplySettings, Granularity, MediaFieldsParameter, PlaceFieldsParameter, PollFieldsParameter, Snowflake, SpaceExpansionsParameter, SpaceFieldsParameter, TweetExpansionsParameter, TweetFieldsParameter, TweetTypeExcludesRequestParameter, UserExpansionsParameter, UserFieldsParameter } from 'twitter-types';
/**
...
export declare type ErrorMessageBuilder = (...args: Array<any>) => string;
