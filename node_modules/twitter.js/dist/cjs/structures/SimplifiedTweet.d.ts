...
import type { TweetLikeResponse, TweetUnlikeResponse, TweetReplyHideUnhideResponse, RetweetResponse, RemovedRetweetResponse } from './misc';
import type { APITweet, APITweetReplySettings, Snowflake } from 'twitter-types';
/**
...
export declare class SimplifiedTweet extends BaseStructure {
     ...
     */
    like(): Promise<TweetLikeResponse>;
    /**
     * Unlikes this tweet.
     * @returns A {@link TweetUnlikeResponse} object
     */
    unlike(): Promise<TweetUnlikeResponse>;
    /**
     ...
     */
    hide(): Promise<TweetReplyHideUnhideResponse>;
    /**
     * Unhides this tweet.
     *
     * **Note:** This tweet should be a reply to a tweet of the authorized user
